...
if (arr === countA) {
    output.innerHTML = `${name.innerHTML} anda terkena gejala Covid varian Alpha`
}
if (arr === countD) {
    output.innerHTML = `${name.innerHTML} anda terkena gejala Covid varian Delta`
}
if (arr === countO) {
    output.innerHTML = `${name.innerHTML} anda terkena gejala Covid varian Omicron`
}
return output
}
